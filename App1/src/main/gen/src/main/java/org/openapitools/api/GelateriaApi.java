...
public interface GelateriaApi {
    ...
    default ResponseEntity<Void> gelateriaGelatiIdDelete(
        @Parameter(name = "id", description = "ID del gelato da cancellare", required = true) @PathVariable("id") Integer id
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Gelato> gelateriaGelatiIdGet(
        @Parameter(name = "id", description = "ID del gelato", required = true) @PathVariable("id") Integer id
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<Void> gelateriaGelatiIdPut(
        @Parameter(name = "id", description = "ID del gelato da aggiornare", required = true) @PathVariable("id") Integer id,
    ...
    default ResponseEntity<Void> gelateriaPrenotaIdPrenotanteIdGelatoDelete(
        @Parameter(name = "id_prenotante", description = "ID del prenotante", required = true) @PathVariable("id_prenotante") Integer idPrenotante,
        @Parameter(name = "id_gelato", description = "ID del gelato", required = true) @PathVariable("id_gelato") Integer idGelato
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> gelateriaPrenotanteIdPrenotanteDelete(
        @Parameter(name = "id_prenotante", description = "ID del prenotante da cancellare", required = true) @PathVariable("id_prenotante") Integer idPrenotante
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> gelateriaPrenotanteIdPrenotantePut(
        @Parameter(name = "id_prenotante", description = "ID del prenotante da aggiornare", required = true) @PathVariable("id_prenotante") Integer idPrenotante,
