...
public interface ApiApi {
    ...
    default ResponseEntity<List<Gelato>> apiGelatiGet(
    ...
    default ResponseEntity<Void> apiGelatiIdDelete(
    ...
    default ResponseEntity<Gelato> apiGelatiIdGet(
    ...
    default ResponseEntity<List<Prenotante>> apiPrenotanteGet(
    ...
    default ResponseEntity<Void> apiPrenotanteIdPrenotanteDelete(
    ...
    default ResponseEntity<Prenotante> apiPrenotanteIdPrenotanteGet(
        @Parameter(name = "id_prenotante", description = "ID del prenotante", required = true, in = ParameterIn.PATH) @PathVariable("id_prenotante") Integer idPrenotante
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
